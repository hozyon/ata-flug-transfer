        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <section className="py-16 md:py-20" style={{ background: '#f8f7f4' }}>
                <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
                    ...
                    <h2 className="text-2xl font-playfair font-bold text-slate-900">{t('moreQ')}</h2>
                    <p className="text-slate-500 mt-2 text-sm">{t('moreQDesc')}</p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 stagger-children">
                        <div className="reveal text-center p-6 rounded-2xl transition-all duration-200 hover:bg-white/[0.03]" style={{ border: '1px solid rgba(255,255,255,0.06)' }}>
                            ...
                            <h3 className="text-white font-bold text-sm">{t('phone')}</h3>
                        ...
                        <div className="reveal text-center p-6 rounded-2xl transition-all duration-200 hover:bg-white/[0.03]" style={{ border: '1px solid rgba(255,255,255,0.06)' }}>
                            ...
                            <h3 className="text-white font-bold text-sm">{t('workHours')}</h3>
                            <p className="text-slate-400 mt-1 text-sm">{t('service247')}</p>
                        </div>
                    </div>
                </div>
            </section>
